          ...
          <div className="row">
            ...
            >
              ...
              >
                ...
                <div className="icon-content">
                  <h4 className="dlab-title">Search Engine Optimization</h4>
                  {/* <p>
            ...
            >
              ...
              >
                ...
                <div className="icon-content">
                  <h4 className="dlab-title">Search Marketing Optimization</h4>
                  {/* <p>
                    Fusce sit amet dui vitae urna tristique imperdiet. Donec
                    eget sapien euismod, faucibus nibh non, consequat elit.
                    Praesent sed vehicula.
            ...
            >
              ...
              >
                ...
                <div className="icon-content">
                  <h4 className="dlab-title">WEBSITES</h4>
                  {/* <p>
                    Fusce sit amet dui vitae urna tristique imperdiet. Donec
                    eget sapien euismod, faucibus nibh non, consequat elit.
                    Praesent sed vehicula.
            ...
            >
              ...
              >
                ...
                <div className="icon-content">
                  <h4 className="dlab-title">Email Marketing</h4>
                  {/* <p>
                    Fusce sit amet dui vitae urna tristique imperdiet. Donec
                    eget sapien euismod, faucibus nibh non, consequat elit.
                    Praesent sed vehicula.
              ...
              >
                ...
                <div className="icon-content">
                  <h4 className="dlab-title">
                    Blog posts/ Brochures/ Brand Magazines
                  </h4>
                  {/* <p>
                    Fusce sit amet dui vitae urna tristique imperdiet. Donec
                    eget sapien euismod, faucibus nibh non, consequat elit.
