          ...
          <div className="row">
            ...
            >
              ...
              >
                ...
                <div className="icon-content">
                  <h4 className="dlab-title">ANALYZING & PLANNING </h4>
                  {/* <p>
            ...
            >
              ...
              >
                ...
                <div className="icon-content">
                  <h4 className="dlab-title">DESIGNING</h4>
                  {/* <p>
                    Fusce sit amet dui vitae urna tristique imperdiet. Donec
                    eget sapien euismod, faucibus nibh non, consequat elit.
                    Praesent sed vehicula.
            ...
            >
              ...
              >
                ...
                <div className="icon-content">
                  <h4 className="dlab-title">UPDATING CLIENTS WITH PROGRESS</h4>
                  {/* <p>
                    Fusce sit amet dui vitae urna tristique imperdiet. Donec
                    eget sapien euismod, faucibus nibh non, consequat elit.
                    Praesent sed vehicula.
            ...
            >
              ...
              >
                ...
                <div className="icon-content">
                  <h4 className="dlab-title">TESTING</h4>
                  {/* <p>
                    Fusce sit amet dui vitae urna tristique imperdiet. Donec
                    eget sapien euismod, faucibus nibh non, consequat elit.
                    Praesent sed vehicula.
            ...
            >
              ...
              >
                ...
                <div className="icon-content">
                  <h4 className="dlab-title">DEPLOYEMENT</h4>
                  {/* <p>
                    Fusce sit amet dui vitae urna tristique imperdiet. Donec
                    eget sapien euismod, faucibus nibh non, consequat elit.
                    Praesent sed vehicula.
            ...
            >
              ...
              >
                ...
                <div className="icon-content">
                  <h4 className="dlab-title">MONITORING</h4>
                  {/* <p>
                    Fusce sit amet dui vitae urna tristique imperdiet. Donec
                    eget sapien euismod, faucibus nibh non, consequat elit.
                    Praesent sed vehicula.
