          ...
          <div className="row">
            ...
            >
              ...
              >
                ...
                <div className="icon-content">
                  <h4 className="dlab-title">ANALYZING & PLANNING PHASE</h4>
                  {/* <p>
            ...
            >
              ...
              >
                ...
                <div className="icon-content">
                  <h4 className="dlab-title">DESIGNING PART</h4>
                  {/* <p>
                    Fusce sit amet dui vitae urna tristique imperdiet. Donec
                    eget sapien euismod, faucibus nibh non, consequat elit.
                    Praesent sed vehicula.
              ...
              >
                ...
                <div className="icon-content">
                  <h4 className="dlab-title">
                    UPDATING CLIENTS WITH PROGRESSS
                  </h4>
                  {/* <p>
                    Fusce sit amet dui vitae urna tristique imperdiet. Donec
                    eget sapien euismod, faucibus nibh non, consequat elit.
            ...
            >
              ...
              >
                ...
                <div className="icon-content">
                  <h4 className="dlab-title">TESTING PHASE</h4>
                  {/* <p>
                    Fusce sit amet dui vitae urna tristique imperdiet. Donec
                    eget sapien euismod, faucibus nibh non, consequat elit.
                    Praesent sed vehicula.
            ...
            >
              ...
              >
                ...
                <div className="icon-content">
                  <h4 className="dlab-title">DEPLOYEMENT PHASE</h4>
                  {/* <p>
                    Fusce sit amet dui vitae urna tristique imperdiet. Donec
                    eget sapien euismod, faucibus nibh non, consequat elit.
                    Praesent sed vehicula.
            ...
            >
              ...
              >
                ...
                <div className="icon-content">
                  <h4 className="dlab-title">MONITORING PHASE</h4>
                  {/* <p>
                    Fusce sit amet dui vitae urna tristique imperdiet. Donec
                    eget sapien euismod, faucibus nibh non, consequat elit.
                    Praesent sed vehicula.
