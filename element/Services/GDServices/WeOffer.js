          ...
          <div className="row">
            ...
            >
              ...
              >
                ...
                <div className="icon-content">
                  <h4 className="dlab-title">LOGO & BRANDING</h4>
                  {/* <p>
            ...
            >
              ...
              >
                ...
                <div className="icon-content">
                  <h4 className="dlab-title">3D DESIGNS</h4>
                  {/* <p>
                    Fusce sit amet dui vitae urna tristique imperdiet. Donec
                    eget sapien euismod, faucibus nibh non, consequat elit.
                    Praesent sed vehicula.
            ...
            >
              ...
              >
                ...
                <div className="icon-content">
                  <h4 className="dlab-title">ANIMATED VIDEOS</h4>
                  {/* <p>
                    Fusce sit amet dui vitae urna tristique imperdiet. Donec
                    eget sapien euismod, faucibus nibh non, consequat elit.
                    Praesent sed vehicula.
            ...
            >
              ...
              >
                <div className="icon-bx-md radius bg-skyblue shadow-skyblue">
                  <a href="javascript:void(0);" className="icon-cell">
                    <i className="ti ti-ruler-pencil"></i>
                  </a>
                </div>
                <div className="icon-content">
                  <h4 className="dlab-title">WEB & MOBILE APP PROTOTYPE</h4>
                  {/* <p>
                    Fusce sit amet dui vitae urna tristique imperdiet. Donec
                    eget sapien euismod, faucibus nibh non, consequat elit.
                    Praesent sed vehicula.
            ...
            >
              ...
              >
                ...
                <div className="icon-content">
                  <h4 className="dlab-title">ADVERTISING</h4>
                  {/* <p>
                    Fusce sit amet dui vitae urna tristique imperdiet. Donec
                    eget sapien euismod, faucibus nibh non, consequat elit.
                    Praesent sed vehicula.
