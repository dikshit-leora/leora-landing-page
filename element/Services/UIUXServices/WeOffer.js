          ...
          <div className="row">
              ...
              >
                ...
                <div className="icon-content">
                  <h4 className="dlab-title">
                    Mobile APP UI/UX DESIGN Service
                  </h4>
                  {/* <p>
            ...
            >
              ...
              >
                ...
                <div className="icon-content">
                  <h4 className="dlab-title">WEB APP UI/UX DESIGN SERVICE</h4>
                  {/* <p>
                    Fusce sit amet dui vitae urna tristique imperdiet. Donec
                    eget sapien euismod, faucibus nibh non, consequat elit.
                    Praesent sed vehicula.
            ...
            >
              ...
              >
                <div className="icon-bx-md radius bg-green shadow-green">
                  <a href="javascript:void(0);" className="icon-cell">
                    <i className="la la-cloud-meatball"></i>
                  </a>
                </div>
                <div className="icon-content">
                  <h4 className="dlab-title">SAAS APP DESIGN SERVICE</h4>
                  {/* <p>
                    Fusce sit amet dui vitae urna tristique imperdiet. Donec
                    eget sapien euismod, faucibus nibh non, consequat elit.
                    Praesent sed vehicula.
            ...
            >
              ...
              >
                ...
                <div className="icon-content">
                  <h4 className="dlab-title">CROSS-PLATFORM DESIGN SERVICE</h4>
                  {/* <p>
                    Fusce sit amet dui vitae urna tristique imperdiet. Donec
                    eget sapien euismod, faucibus nibh non, consequat elit.
                    Praesent sed vehicula.
            ...
            >
              ...
              >
                ...
                <div className="icon-content">
                  <h4 className="dlab-title">UI/ UX CONSULTING</h4>
                  {/* <p>
                    Fusce sit amet dui vitae urna tristique imperdiet. Donec
                    eget sapien euismod, faucibus nibh non, consequat elit.
                    Praesent sed vehicula.
            ...
            >
              ...
              >
                <div className="icon-bx-md radius bg-maroon shadow-maroon">
                  <a href="javascript:void(0);" className="icon-cell">
                    <i className="la la-brain"></i>
                  </a>
                </div>
                <div className="icon-content">
                  <h4 className="dlab-title">AR EXPERIENCE DESIGN</h4>
                  {/* <p>
                    Fusce sit amet dui vitae urna tristique imperdiet. Donec
                    eget sapien euismod, faucibus nibh non, consequat elit.
                    Praesent sed vehicula.
