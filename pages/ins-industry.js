...
import Intro from "../element/Industries/Insurance/Intro";
    ...
    <>
      ...
      <div className="page-content bg-white">
            ...
            <div className="container">
              <div className="row align-items-center">
                ...
                >
                  ...
                  <p>
                    Our software solutions cover all the operations that your
                    business follows
                  </p>
                  <ul className="list-check style-1 primary m-b30">
                    <li>Suitable for all businesses size.</li>
        ...
        <h4 className="text-center">
          “ENSURE YOUR CUSTOMER WITH RIGHT CHOICE”
        </h4>
        <br />
      </div>
      <Footer />
